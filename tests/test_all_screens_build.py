...
SCREEN_MIN_CFGS = {
    ...
    "seed_transcribe_whole_qr_screen": {"top_nav": {"title": "Transcribe"},
                                        ...
                                        "button_list": ["Done"]},
    "seed_transcribe_seedqr_format_screen": {"top_nav": {"title": "SeedQR Format"},
                                             "standard_label": "Standard",
                                             "standard_text": "BIP-39 wordlist indices",
                                             "compact_label": "Compact",
                                             "compact_text": "Raw entropy bits",
                                             "button_list": ["Standard: 25x25", "Compact: 21x21"]},
    ...
    "seed_address_verification_screen": {"top_nav": {"title": "Verify Address"},
                                         ...
                                         "button_list": ["Next"]},
    "seed_address_verification_success_screen": {"top_nav": {"title": "Success!"},
                                                 "status_headline": "Address Verified",
                                                 "address": _ADDR,
                                                 "address_type_text": "receive address",
                                                 "index_text": "index 0",
                                                 "button_list": ["OK"]},
    ...
    "tools_address_explorer_address_type_screen": {"top_nav": {"title": "Address Explorer"},
                                                   "fingerprint": "0abc1234",
                                                   "fingerprint_label": "Fingerprint",
                                                   "derivation_text": "Native Segwit",
                                                   "derivation_label": "Derivation",
                                                   "button_list": ["Receive", "Change"]},
    ...
    "power_options_screen": {"top_nav": {"title": "Reset / Power"},
                             "button_list": ["Restart", "Power Off"]},
    "donate_screen": {"top_nav": {"title": "Donate"}, "text": "Support SeedSigner",
                      "url": "https://seedsigner.com"},
    "version_screen": {"top_nav": {"title": "Version"}, "version_name": "v0.8.7-3-gabc1234",
                       "version_fork": "SeedSigner", "short_commit_hash": "abc1234",
                       "version_timestamp": "2026-07-21 14:30:00 UTC"},
